...
/*****************************************************************************/
/*                                                                           */
/*  Author: Iain Lewis (Iain_Lewis@uk.ibm.com), August 2004 (version 3)      */
/*                                                                           */
/*****************************************************************************/
...
public class TerseDecompress {
    ...
    */
    ...
    static final String DetailedHelp = new String(
          "Usage: \"Terse <input file> <output file> [-b]\"\n\n"
    ...
    */
     ...
     * We assume that we get "terse <input file> <output file>". Otherwise exit with
     * an error message.
     */
